(() => {
        ...
        if ("click" === s) {
          if (!a.disabled)
            if (
              ...
              this.setDisableAfterSelectsForSend(s), this.optionAction(i, a, e);
            }
        } else
  ...
  function X(e) {
    ...
    if (!i.isMoved) {
      if (
        (y && w && s.loopFix({ direction: s.swipeDirection }),
  ...
  class oe {
    ...
    getSlideIndex(e) {
      const { slidesEl: t, params: s } = this,
        i = O(L(t, `.${s.slideClass}, swiper-slide`)[0]);
      return O(e) - i;
    }
  ...
  function he(e) {
    ...
    function y(e) {
      i &&
        ...
        (i.wrapperEl.removeEventListener("transitionend", y), x());
    }
    const S = () => {
      ...
      A = (e) => {
        "mouse" === e.pointerType &&
          ((m = !0), i.animating || i.autoplay.paused || C(!0));
      },
      P = (e) => {
        "mouse" === e.pointerType && i.autoplay.paused && x();
      };
    l("init", () => {
      i.params.autoplay.enabled &&
        ...
        g().addEventListener("visibilitychange", L),
        (b = new Date().getTime()),
        E());
    }),
      l("destroy", () => {
        i.el.removeEventListener("pointerenter", A),
          ...
          g().removeEventListener("visibilitychange", L),
          i.autoplay.running && T();
      }),
      l("beforeTransitionStart", (e, t, s) => {
        !i.destroyed &&
          i.autoplay.running &&
          (s || !i.params.autoplay.disableOnInteraction ? C(!0, !0) : T());
      }),
      l("sliderFirstMove", () => {
        !i.destroyed &&
          i.autoplay.running &&
      ...
      l("touchEnd", () => {
        if (!i.destroyed && i.autoplay.running && d) {
          if (
            ...
            return (p = !1), void (d = !1);
          p && i.params.cssMode && x(), (p = !1), (d = !1);
        }
      }),
      l("slideChange", () => {
        !i.destroyed && i.autoplay.running && (h = !0);
      }),
      Object.assign(i.autoplay, { start: E, stop: T, pause: C, resume: x });
  }
  function me() {
