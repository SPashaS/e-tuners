(() => {
          ...
          void 0 !== r &&
            ...
            (v(e[i]) && v(n[i])
              ? n[i].__swiper__
                ...
                : g(e[i], n[i])
              : !v(e[i]) && v(n[i])
              ? ((e[i] = {}), n[i].__swiper__ ? (e[i] = n[i]) : g(e[i], n[i]))
              : (e[i] = n[i]));
        }
      }
    }
  ...
  function F(e) {
    ...
    for (
      ...
      void 0 !== l[e + t]
        ? u >= l[e] && u < l[e + t] && ((f = e), (v = l[e + t] - l[e]))
        : u >= l[e] && ((f = e), (v = l[l.length - 1] - l[l.length - 2]));
    }
    let g = null,
      b = null;
    n.rewind &&
  ...
  window.addEventListener("load", function (e) {
    oe(),
      ...
      le("(max-width: 1280px)", ".why-we__slider", {
        modules: [ae],
        slidesPerView: 1,
        speed: 800,
      ...
      le("(max-width: 768px)", ".desc__slider", {
        modules: [ae],
        slidesPerView: 1,
        autoHeight: !0,
        speed: 800,
      ...
      le("(max-width: 768px)", ".connect__slider", {
        modules: [ae],
        slidesPerView: 1,
        spaceBetween: 20,
        speed: 800,
